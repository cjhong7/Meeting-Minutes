...
4. 분량 및 요약 규칙 (★ 중요)
   - 전체 분량은 A4 한 페이지 이내로 핵심만 간결하게 정리
   - 각 안건마다 가.나.다. 세부 항목은 2~4개 정도가 적당 (과도하게 길게 쓰지 말 것)
   - 각 항목은 한 문장으로 핵심만 압축 (긴 설명·배경 서술 금지)
   - 날짜·담당자·기한·장소 등 구체적 정보는 포함하되 군더더기 표현 제거
   - "~에 대해 논의함" 같은 모호한 표현 대신 구체적 결정 내용 기재
   - 같은 안건의 관련 내용은 반드시 해당 안건 번호 아래에 묶기
   - 회의의 핵심 결정·논의 사항만 추려 담고, 부차적 내용은 생략
