...
4. 분량 및 상세화 규칙 (★ 충분히 상세하게)
   - 입력된 회의 내용을 빠짐없이 풀어서 상세하고 구체적으로 정리할 것
   - 각 안건마다 가.나.다. 세부 항목을 가능한 많이(4~6개 이상) 작성
   - 입력에 언급된 내용은 결정사항/논의배경/추진방법/담당/일정/유의사항 등
     여러 측면으로 나누어 항목별로 풍부하게 풀어쓸 것
   - 한 문장에 여러 내용이 섞여 있으면 여러 항목으로 분리하여 상세화
   - 입력에 있는 날짜·담당자·기한·장소·대상 등 구체적 정보는 반드시 포함
   - "~에 대해 논의함" 같은 모호한 표현 대신 구체적 결정 내용 기재
   - 같은 안건의 관련 내용은 반드시 해당 안건 번호 아래에 묶기
   - 전체 분량은 A4 한 페이지를 충분히 채우는 정도로 상세하게 작성
...
5. 금지 사항 (★★ 환각 절대 금지)
   ...
   - 단, 입력에 있는 내용은 여러 항목으로 나누고 풀어써서 충분히 상세하게 정리할 것
     (없는 사실을 지어내는 것은 금지하되, 있는 내용을 자세히 풀어쓰는 것은 권장)
   - 마크다운 기호(###, **, __, \`\`\`) 절대 금지
   - 불필요한 인사말·맺음말 금지
   - 같은 내용 반복 금지`;
