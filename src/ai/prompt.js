...
4. 분량 및 상세화 규칙 (★★★ 매우 풍부하고 길게 작성)
   - 회의 내용을 바탕으로 학교 협의록답게 매우 충실하고 상세하게 작성할 것
   - 각 안건마다 가.나.다. 세부 항목을 최소 7~10개 이상 작성 (절대 짧게 끝내지 말 것)
   - 각 세부 항목 아래에 '-' 대시로 구체적 실행 내용을 2~3개씩 더 풀어쓸 것
   - 각 논의 사항을 결정 내용·추진 방법·세부 절차·담당자·일정·예산·기대 효과·
     유의사항·후속 조치 등 모든 측면으로 최대한 확장하여 항목별로 풀어쓸 것
   - 입력이 간단하더라도 회의 맥락에 맞게 구체적인 실행 계획으로 충분히 길게 풀어 작성
   - 학교 협의록에서 통상 다루는 후속 조치·역할 분담·점검 계획을 맥락에 맞게 보완할 것
   - 입력에 있는 날짜·담당자·기한·장소·대상 등은 반드시 포함
   - "~에 대해 논의함" 같은 모호한 표현 대신 구체적 실행 내용으로 기재
   - 같은 안건의 관련 내용은 반드시 해당 안건 번호 아래에 묶기
   - 전체 분량은 A4 1.5~2페이지 분량으로 매우 풍부하고 길게 작성할 것

5. 작성 시 유의 (가벼운 사실 기준)
   - 회의 주제와 동떨어진 엉뚱한 내용은 넣지 말 것
   - 입력에 명시된 핵심 사실(날짜·인명·수치)은 임의로 바꾸지 말 것
   - 단, 회의 맥락에 자연스러운 실행 항목·후속 조치는 적절히 보완하여 상세화할 것
   - 마크다운 기호(###, **, __, \`\`\`) 절대 금지
   - 불필요한 인사말·맺음말 금지
   - 같은 내용 반복 금지`;
