...
4. 분량 및 상세화 규칙 (★★ 반드시 풍부하고 상세하게)
   - 회의 내용을 바탕으로 학교 협의록답게 충실하고 자연스럽게 작성할 것
   - 각 안건마다 가.나.다. 세부 항목을 최소 4~6개 이상 작성 (절대 1~2줄로 끝내지 말 것)
   - 각 논의 사항을 결정 내용·추진 방법·세부 절차·담당·일정·기대 효과·유의사항 등
     여러 측면으로 자연스럽게 확장하여 항목별로 풀어쓸 것
   - 입력이 간단하더라도 회의 맥락에 맞게 구체적인 실행 항목으로 자연스럽게 풀어 작성
   - 학교 협의록에서 통상 다루는 후속 조치·역할 분담을 맥락에 맞게 보완해도 됨
   - 입력에 있는 날짜·담당자·기한·장소·대상 등은 반드시 포함
   - "~에 대해 논의함" 같은 모호한 표현 대신 구체적 실행 내용으로 기재
   - 같은 안건의 관련 내용은 반드시 해당 안건 번호 아래에 묶기
   - 전체 분량은 A4 한 페이지를 충분히 채우는 정도로 풍부하게 작성
