...
5. 작성 시 유의 (사실 기준 — 환각 주의 ★)
  ...
  // ── 펜(손글씨 OCR) 모드: 환각 방지 최대 강화 ──
  const penNote = mode === 'pen'
    ? `

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[펜(손글씨) 모드 특별 지침 ★★★ 환각 절대 금지]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- 입력은 손글씨를 인식한 결과로, 불완전하거나 일부 오인식이 있을 수 있음
- 오직 입력에 적힌 단어·문장만 사용하여 정리할 것 (그 외 일체 추가 금지)
- 불명확하거나 오인식된 부분은 추측하지 말고 적힌 그대로 두거나 생략할 것
- 손글씨에 없는 새로운 내용·후속 조치·실행 계획·일반론을 절대 추가하지 말 것
- 맥락상 그럴듯한 보완·확장도 하지 말 것 (있는 내용만 양식에 맞게 배치)
- 입력 단어 수를 크게 넘어서는 분량으로 부풀리지 말 것
- 인식된 핵심 단어·표현을 최대한 그대로 살려 간결하게 정리할 것`
    : '';
