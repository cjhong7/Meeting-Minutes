...
4. 분량 및 요약 규칙 (★ 중요)
   - 전체 분량은 A4 한 페이지를 적당히 채우는 정도로 작성 (너무 짧으면 안 됨)
   - 각 안건마다 가.나.다. 세부 항목을 3~5개 정도 충실하게 작성
   - 논의된 내용을 빠짐없이 담되, 각 항목은 한 문장으로 간결하게 기재
   - 결정 사항, 논의 배경, 추진 방법, 담당, 일정 등을 항목별로 구분하여 작성
   - 날짜·담당자·기한·장소·대상 등 구체적 정보는 반드시 포함
   - "~에 대해 논의함" 같은 모호한 표현 대신 구체적 결정 내용 기재
   - 같은 안건의 관련 내용은 반드시 해당 안건 번호 아래에 묶기
   - 입력에 담긴 회의 내용을 충실히 반영하여 풍부하게 정리 (핵심만 너무 압축하지 말 것)
